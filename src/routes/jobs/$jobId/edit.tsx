    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 font-sans p-6 sm:p-10">
      <div className="max-w-md mx-auto">
        <div className="mb-6">
          <Link
            to="/jobs"
            className="text-xs text-green-400 font-medium text-gray-500 hover:text-gray-700 inline-flex items-center gap-1 mb-3"
          >
        ...
        <form className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col gap-5 shadow-sm text-slate-900">
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <input
              ...
              name="company"
              required
              defaultValue="Simplepay Capital"
              className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-slate-900 placeholder-gray-400 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
          </label>
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <input
              type="text"
              name="location"
              defaultValue="Nairobi, KE · Hybrid"
              className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-slate-900 placeholder-gray-400 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
          </label>
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <input
              type="url"
              name="link"
              defaultValue="https://simplepay.example.com/careers/backend-engineer"
              className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-slate-900 placeholder-gray-400 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
          </label>
